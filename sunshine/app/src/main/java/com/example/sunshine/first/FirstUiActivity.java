...
public class FirstUiActivity extends AppCompatActivity {
    ...
    class OnClick implements View
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.bn_1:
                    intent=new Intent(FirstUiActivity.this,WeatherFirstActivity.class);
                    startActivity(intent);
                    break;
                case R.id.bn_2:
                    intent=new Intent(FirstUiActivity.this,WeatherSecond.class);
                    startActivity(intent);
                    break;
                case R.id.bn_3:
                    intent=new Intent(FirstUiActivity.this,LifeCycleActivity2.class);
                    startActivity(intent);
                    break;
            }
        }

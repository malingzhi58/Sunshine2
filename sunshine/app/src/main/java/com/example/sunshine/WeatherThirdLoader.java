...
/**
 * Loader helps us with multiple AsyncTasks
 * if we create an AsyncTask and rotate the
 * instruction:
 * 1.the class implements LoaderCallBacks interface
 * 2.create a new Loader ID
 * 3.override the LoaderCallBacks methods
 * 4.replace the AsycTask method in the onCreate with initLoader method
 * 5.update the menu(onOptionsItemSelected) method, use the Loader method
 *
 */
public class WeatherThirdLoader extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather_third);
         ...
         */
        LoaderManager.LoaderCallbacks<String[]> callback = WeatherThirdLoader.this;
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                String locationQuery = SunshinePreferences
                        .getPreferredWeatherLocation(WeatherThirdLoader.this);
                ...
                try {
                    ...
                    String[] simpleJsonWeatherData = OpenWeatherJsonUtils
                            .getSimpleWeatherStringsFromJson(WeatherThirdLoader.this, jsonWeatherResponse);

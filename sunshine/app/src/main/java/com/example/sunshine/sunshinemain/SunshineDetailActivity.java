...
import com.example.sunshine.databinding.ActivitySunshineDetailBinding;
import com.example.sunshine.utilities.SunshineDateUtils;
import com.example.sunshine.utilities.SunshineWeatherUtils;

public class SunshineDetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
...
//  COMPLETED (3) Declare an ActivityDetailBinding field called mDetailBinding
    private ActivitySunshineDetailBinding mDetailBinding;
    @Override

package com.example.sunshine.background.utilities;
...
import com.example.sunshine.RoomActivity;
...
import com.example.sunshine.sunshinemain.SunshineDetailActivity;
import com.example.sunshine.utilities.SunshineDateUtils;
import com.example.sunshine.utilities.SunshineWeatherUtils;

/*
create a method makes a PendingIntent which will open up the Hydration Reminder APP
create a method that returns an appropriately icon for your notification
create a method called remindUserBecauseCharging that creates a notificaiton
 */
public class NotificationUtils {
    ...
    /*
    used by PendingIntent contentIntent(Context context)
     */
    public static int WATER_REMINDER_PENDING_INTENT_ID=1034;
    /*
    used by notificationManager.notify(WATER_REMINDER_NOTIFICATION_ID,builder.build());
     */
    public static int WATER_REMINDER_NOTIFICATION_ID=1142;
    /*
    used by Notification Channel
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
             ...
             */
            Intent detailIntentForToday = new Intent(context, SunshineDetailActivity.class);
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(WATER_REMINDER_NOTIFICATION_CHANNEL_ID,context.getString(R.string.main_notification_channel_name),
    ...
    public static Action ignoreReminderAction(Context context){
        ...
        intent.setAction(ReminderTasks.CLEAR_NOTIFICATION);
        //ACTION_IGNORE_PENDING_INTENT_ID is a special request ID
    ...
    private static Action drinkWaterAction(Context context){
        ...
        Action action = new Action(R.drawable.ic_local_drink_black_24px,"I will drink",pendingIntent);
        return action;
    }
}
